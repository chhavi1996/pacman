...
public class ScoreServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req,HttpServletResponse res) throws IOException,ServletException {
		...
		try{
			...
			Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/score","root","mysql@123");
			PreparedStatement pst=con.prepareStatement("Select * from ScoreCard ORDER BY HighScore DESC");
			rs=pst.executeQuery();
